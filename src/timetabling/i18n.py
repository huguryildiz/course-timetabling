...
STRINGS = {
    "tr": {
        ...
        "app_title": "Ders Programı Çözücü",
        "app_subtitle": "UCTP · CP-SAT",
        "appbar_waiting": "Veri bekleniyor",
        "appbar_loaded": "{n} şube yüklü",
        "theme_toggle": "Tema",
        ...
        # sample data
        "upload_sample_btn": "Örnek veri ile dene",
        "upload_sample_caption": "Gerçek CSV gerekmez — örnek veri ile tüm akışı deneyebilirsin.",
        # kpi labels
        "kpi_sections": "Şube",
        "kpi_courses": "Ders",
        "kpi_depts": "Bölüm",
    ...
    "en": {
        "lang_label": "Dil / Language",
        "nav_home": "Home",
        "app_title": "Course Timetabling",
        "app_subtitle": "UCTP · CP-SAT",
        "appbar_waiting": "Waiting for data",
        "appbar_loaded": "{n} sections loaded",
        "theme_toggle": "Theme",
        ...
        "upload_sample_btn": "Try sample data",
        "upload_sample_caption": "No real CSV needed — try the whole flow with sample data.",
