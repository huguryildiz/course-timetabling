...
STRINGS = {
    "tr": {
        ...
        "set_include_grad": "Lisansüstü dersleri dahil et",
        ...
        "set_lunch": "Öğle arası koruması",
        "set_lunch_help": "Açıkken her gün belirtilen saat aralığı ders dışı bırakılır (kesin kural). Hiçbir ders bu pencereye yerleştirilmez.",
        ...
        "set_w_cohort_gap_help": "Aynı kohortun (bölüm/yıl) derslerini gün içinde arka arkaya tutmayı tercih eder; öğrencilerin boşta beklediği süreyi azaltır.",
        "set_w_room_count": "Az sayıda oda kullan",
        "set_w_room_count_help": "Haftada kullanılan benzersiz derslik sayısını düşürmeyi tercih eder; az sayıda odayı açık tutmak isteyen okullar için uygundur.",
    ...
    "en": {
        ...
        "set_include_grad": "Include graduate courses",
        ...
        "set_lunch": "Lunch-break protection",
        "set_lunch_help": "When on, the given hour window is kept class-free every day (hard rule). No session is placed inside it.",
        ...
        "set_w_cohort_gap_help": "Prefers placing sessions for the same cohort (department/year) consecutively within a day, reducing idle gaps students spend waiting.",
        "set_w_room_count": "Use fewer rooms",
        "set_w_room_count_help": "Prefers using fewer distinct rooms across the week — useful for schools that want to minimise which rooms must be opened and cleaned.",
